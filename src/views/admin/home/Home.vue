    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
        ...
        <el-menu background-color="#333744" text-color="#fff" :router="true"
          ...
          <el-menu-item @click="saveNavState(item.path)" :index="item.path" v-for="item in menulist" :key="item.path">
...
<script>
import { adminRouter } from '@/router/router-all'
...
export default {
  ...
  // Vue周期函数
  created() {
    this.menulist = adminRouter[0].children
